...
- `gradle/verification-metadata.xml` verifies both artifacts and Maven/Gradle metadata with
  ...
  Minecraft, mappings, transform, runtime, native, and E2E classpaths for the active 1.21.6 graph.
...
Minecraft 1.21.6's version manifest selects
...
./gradlew --no-daemon --no-parallel \
  ...
  :common:1.21.6:dependencies \
  :fabric:1.21.6:dependencies \
  :neoforge:1.21.6:dependencies
```
