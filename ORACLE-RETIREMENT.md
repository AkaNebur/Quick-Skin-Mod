...
Minecraft 26.2 remains the canonical source era. This 26.1 branch routes its single
immediate-extraction preview backend through `common/src/legacy26_1`; Fabric otherwise uses canonical
