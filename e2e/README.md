...
This `fabric-and-neoforge-1.21.3` release branch exercises the following exact packaged lanes:

| Artifact | Minecraft | Loader | Java | Contract scenarios |
|---|---:|---|---:|---:|
| `fabric-1.21.3` | `1.21.3` | Fabric | `21` | `4` |
| `neoforge-1.21.3` | `1.21.3` | NeoForge | `21` | `4` |
