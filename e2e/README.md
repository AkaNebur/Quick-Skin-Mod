...
This `fabric-and-neoforge-1.21.4` release branch exercises the following exact packaged lanes:

| Artifact | Minecraft | Loader | Java | Contract scenarios |
|---|---:|---|---:|---:|
| `fabric-1.21.4` | `1.21.4` | Fabric | `21` | `4` |
| `neoforge-1.21.4` | `1.21.4` | NeoForge | `21` | `4` |
