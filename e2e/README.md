...
Minecraft 1.21.8 release files and two matching runtime rows: Fabric and NeoForge. Every artifact
advertises and launches on exactly Minecraft 1.21.8; matrix validation fails if any consumer-facing
