...
This `fabric-and-neoforge-26.1.2` release branch exercises the following exact packaged lanes:

| Artifact | Minecraft | Loader | Java | Contract scenarios |
|---|---:|---|---:|---:|
| `fabric-26.1.2` | `26.1.2` | Fabric | `25` | `4` |
| `neoforge-26.1.2` | `26.1.2` | NeoForge | `25` | `4` |
