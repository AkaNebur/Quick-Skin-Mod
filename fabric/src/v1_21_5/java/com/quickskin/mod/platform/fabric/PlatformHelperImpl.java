 ...
 * - graphics.blit(ResourceLocation, ...) → graphics.blit(RenderType::guiTextured, ResourceLocation, ...)
 */
...
public class PlatformHelperImpl {
     ...
     * For MC 1.21.5 (1.21.2+), uses the 12-param blit overload with separate region sizes
     */
    public static void blit(GuiGraphics graphics, ResourceLocation texture, int x, int y, int width, int height, float u, float v, int regionWidth, int regionHeight, int textureWidth, int textureHeight) {
        // 12-param: blit(Function, RL, x, y, u, v, width, height, regionWidth, regionHeight, textureWidth, textureHeight)
