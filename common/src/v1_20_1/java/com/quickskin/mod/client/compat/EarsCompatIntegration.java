...
public class EarsCompatIntegration {
     ...
     *
     * @param skinLocation The ResourceLocation where the skin texture is registered
    ...
    /**
     * Get stored Ears features for a skin ResourceLocation.
     *
     * @param skinLocation The ResourceLocation of the skin texture
    ...
    /**
     * Get the skin ResourceLocation from a player object using reflection.
     * Used by the mixin to handle different mapping schemes (Yarn vs Mojang).
     */
    public static ResourceLocation getSkinLocationFromPlayer(Object player) {
        ...
        try {
            // Try Fabric/Yarn mapped name: getSkinTexture() returns Identifier
        ...
        try {
            // Try Mojang mapped name: getSkinTextureLocation() returns ResourceLocation
