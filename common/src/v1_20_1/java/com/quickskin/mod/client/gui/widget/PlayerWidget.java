...
public class PlayerWidget extends AbstractWidget {
    ...
    // Dragging state for repositioning (customization mode only)
    ...
    public void renderWidget(GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        // Render border around actual player model rendering area
        // Show only when customization is enabled (not during rotation)
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        ...
        // Check if mouse is inside the model area
    ...
    public boolean mouseScrolled(double mouseX, double mouseY, double delta) {
        ...
        // Check if mouse is inside the model area (green border)
        if (!isMouseOver(mouseX, mouseY)) {
            return false;
        }
     ...
     * Always uses the model area (green border) for interaction.
     *
     * IMPORTANT: When actively dragging or rotating, always return true to continue
     * receiving mouse events even if the cursor moves outside the widget area.
     */
    @Override
