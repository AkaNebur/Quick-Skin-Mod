...
public class PlatformHelper {
     ...
     * @param graphics The GuiGraphicsExtractor
     ...
     */
    @ExpectPlatform
    public static void blit(GuiGraphicsExtractor graphics, Identifier texture, int x, int y, int blitOffset, float u, float v, int width, int height, int textureWidth, int textureHeight) {
        throw new AssertionError();
    }
     ...
     */
    @ExpectPlatform
    public static void blit(GuiGraphicsExtractor graphics, Identifier texture, int x, int y, int width, int height, float u, float v, int regionWidth, int regionHeight, int textureWidth, int textureHeight) {
        throw new AssertionError();
    }
