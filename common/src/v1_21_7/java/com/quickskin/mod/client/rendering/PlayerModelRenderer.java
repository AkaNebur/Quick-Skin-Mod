...
public class PlayerModelRenderer {
    ...
    public static void renderPlayerModel(
        ...
        // Create GuiGraphics wrapper - 1.21.6: GuiGraphics(Minecraft, GuiRenderState)
        Minecraft mc = Minecraft.getInstance();
        GuiGraphics graphics = new GuiGraphics(mc, new net.minecraft.client.gui.render.state.GuiRenderState());
