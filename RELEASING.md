...
is `mc1.21.7-v3.0.0`, and the matrix binds it to `fabric-and-neoforge-1.21.7`.
...
git switch fabric-and-neoforge-1.21.7
git pull --ff-only origin fabric-and-neoforge-1.21.7
python scripts/release/release_identity.py
git tag --sign mc1.21.7-v3.0.0
git push origin refs/tags/mc1.21.7-v3.0.0
```
...
```bash
gh attestation verify "Quick Skin - Fabric - 1.21.7-3.0.0.jar" \
