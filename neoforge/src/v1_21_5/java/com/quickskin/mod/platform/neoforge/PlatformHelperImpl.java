...
public class PlatformHelperImpl {
    ...
    private static void initializeBlitMethod2() {
        ...
        // 1.21.2+: Try 12-param with separate regionWidth/regionHeight first
        // blit(Function, ResourceLocation, x, y, u, v, width, height, regionWidth, regionHeight, textureWidth, textureHeight)
        try {
            blitMethod2 = GuiGraphics.class.getMethod("blit",
                java.util.function.Function.class, ResourceLocation.class, int.class, int.class,
        ...
        // 1.21.6+: Try 12-param with RenderPipeline instead of Function
        try {
     ...
     * Compatible with both MC 1.21.1 (no Function parameter) and 1.21.2+ (requires Function/RenderPipeline parameter)
     *
    ...
    public static void blit(GuiGraphics graphics, ResourceLocation texture, int x, int y, int width, int height, float u, float v, int regionWidth, int regionHeight, int textureWidth, int textureHeight) {
        ...
        try {
            ...
            if (paramTypes[0] == ResourceLocation.class) {
                ...
                // Signature: blit(Function/RenderPipeline, RL, x, y, u, v, width, height, regionWidth, regionHeight, textureWidth, textureHeight)
                ...
                // Signature: blit(Function/RenderPipeline, RL, x, y, u, v, width, height, textureWidth, textureHeight)
                Object renderTypeArg = getRenderTypeGuiTextured();
