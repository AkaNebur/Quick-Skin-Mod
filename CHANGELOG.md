...
- Restored `.cpmmodel` discovery, import, preview, selection, and CPM lifecycle integration on both
  Minecraft 1.21.10 loader lanes.
- Restored optional 3D Skin Layers preview integration for the supported 1.21.10 render path.
...
- Made the exact negotiated connection profile authoritative for mandatory S2C channels, avoiding
  false-negative loader channel probes while keeping pre-classification and optional channels
  fail-closed.
...
- Isolated the active Minecraft 1.21.10 Fabric and NeoForge release lanes on their own thin branch.
