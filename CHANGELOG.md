...
- Restored `.cpmmodel` discovery, import, preview, selection, and CPM lifecycle integration on both
  Minecraft 1.21.2 loader lanes.
- Restored optional 3D Skin Layers preview integration for the supported 1.21.2 render path.
...
- Isolated the active Minecraft 1.21.2 Fabric and NeoForge release lanes on their own thin branch.
