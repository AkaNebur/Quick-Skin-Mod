...
- `common/src/test`: loader-independent JUnit regression tests compiled against the common 1.21.9
  node.
...
|---|---|---|
| common | 1.21.9 | `common/src/legacy1_21_9` |
| fabric | 1.21.9 | none; canonical output |
| neoforge | 1.21.9 | none; canonical output |

The common overlay contains only the additive 1.21.9 render, networking, and platform backends.
