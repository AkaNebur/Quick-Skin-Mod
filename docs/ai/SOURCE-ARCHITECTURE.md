...
- `common/src/test`: loader-independent JUnit regression tests compiled against the common 26.2
  node.
...
| fabric | 26.2 | none; canonical output |
| neoforge | 26.2 | none; canonical output |

Minecraft 26.2 is the canonical source era. Common, Fabric, and NeoForge all use their
Stonecutter-generated canonical sources directly on this branch.
